...
// COMANDO ---------------------
        ...
        if (canal) {
          try{
            ...
            `UPDATE guildconfig SET ban2 = '${canal.id}' WHERE guildId = '${message.guild.id}'`
            )
            let embed = new Discord.MessageEmbed()

            .setColor("#964b00") 
            .setTitle(`${message.author.username}`) 
            .setDescription(`**Canal de banimentos setado com sucesso! <a:verify:687759351330766901> \n \n  O canal setado como: **\n${canal}`)
