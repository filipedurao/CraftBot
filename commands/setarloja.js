...
// COMANDO ---------------------
        ...
        if (novoIP) {
          try{
            ...
            `UPDATE guildconfig SET loja = '${novoIP}' WHERE guildId = '${message.guild.id}'`
            )
            let embed = new Discord.MessageEmbed()

            .setColor("#964b00") 
            .setTitle(`${message.author.username}`) 
            .setDescription(`**Link da loja setada com sucesso! <a:verify:687759351330766901> \n \n  O link foi setado como: **\n${novoIP}`)
