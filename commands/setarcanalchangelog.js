...
// COMANDO ---------------------
        ...
        if (canal) {
          try{
            ...
            `UPDATE guildconfig SET changelog = '${canal.id}' WHERE guildId = '${message.guild.id}'`
            )
            let embed = new Discord.MessageEmbed()

            .setColor("#964b00") 
            .setTitle(`${message.author.username}`) 
            .setDescription(`**Canal de change-log setado com sucesso! <a:verify:687759351330766901> \n \n  O canal setada como: **\n${canal}`)
