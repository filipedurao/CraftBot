...
// COMANDO ---------------------
        ...
        if (canal) {
          try{
            ...
            `UPDATE guildconfig SET cash = '${canal.id}' WHERE guildId = '${message.guild.id}'`
            )
            let embed = new Discord.MessageEmbed()

            .setColor("#964b00") 
            .setTitle("Sistema de solicitar cash")
            .setDescription("\n > Para solicitar Cash digite aqui neste canal: \n ```/solicitar cash```\n Digite sua sugestão após o comando **/solicitar cash**\n Ex: `/solicitar cash youtube.com`") 
